...
namespace Ch10TicTacToe
{
    class Program
    {
        ...
        {
            // Wanted to find an alternative, rather than hard-typing each if-statement (DRY).
            // Considering I used an outside source, I'm cool with not getting a bonus here.
            // Source/help: https://stackoverflow.com/questions/47115924/displaying-xs-and-os-for-c-sharp-tic-tac-toe
        ...
        static bool DidPlayerWin(char[,] ticTacToeBoard) // not used //
        {
